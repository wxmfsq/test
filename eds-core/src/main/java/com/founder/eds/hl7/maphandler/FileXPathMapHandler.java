package com.founder.eds.hl7.maphandler;
...
public class FileXPathMapHandler implements XPathMapHandler
{
    ...
    private String propertiesDir = "META-INF/com/founder/eds/xpathmapping/";
            ...
            throws Exception
    {
        ...
        Properties properties = PropertiesLoaderUtils.loadAllProperties(this.propertiesDir + messageId.toLowerCase()
