...
import com.founder.eds.hl7.util.XmlXPathUtil;
import com.founder.eds.hl7.xml.BaseValueHandler;
import com.founder.eds.hl7.xml.ValueHandlerFactory;
...
public class Hl7v3XmlProcessor<T>
{
     ...
     * 创建XML文档的模板文件存放路径
     */
    private String templateDir = "com/founder/cdr/mq/xmltemplate/";
    ...
    {
    	Document doc = util.loadXMLResource(Thread.currentThread().getContextClassLoader().getResourceAsStream(this.templateDir+template.toLowerCase() + this.templateSuffix));
    	System.out.println(this.templateDir+template.toLowerCase() + this.templateSuffix);
